...
if __name__ == '__main__':
            ...
            file1 = open('./milV.txt', 'r')
            #rand walk
            
            edges = []
            vertices = []

            val_vert = int(file1.readline())
            val_edge = int(file1.readline())
            ...
            file2 = open("randWalk.txt", "w")

            file2.write(str(time_of_rand_walk))
            file2.write(", ")
            file2.write(str(cost_total))
            file2.write(", ")
            file2.write(str(counter_steps))
            file2.write(", ")      
            file2.write(str(memory))
            ...
            file3 = open("minWeight.txt", "w")  

            file3.write(str(time_of_rand_walk))
            file3.write(", ")
            file3.write(str(cost_total))
            file3.write(", ")
            file3.write(str(counter_steps))
            file3.write(", ")      
            file3.write(str(memory))
            ...
            file4 = open("primMST.txt", "w")  
            
            file4.write(str(time_of_rand_walk))
            file4.write(", ")
            file4.write(str(cost_total))
            file4.write(", ")
            file4.write(str(counter_steps))
            file4.write(", ")      
            file4.write(str(memory))
            ...
            file5 = open("kruskalMST.txt", "w")  
            

            file5.write(str(time_of_rand_walk))
            file5.write(", ")
            file5.write(str(cost_total))
            file5.write(", ")
            file5.write(str(counter_steps))
            file5.write(", ")      
            file5.write(str(memory))
